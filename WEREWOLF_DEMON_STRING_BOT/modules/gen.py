...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@SweetToxicUpdate"))
        else:
            ...
            await client.join_chat("SweetToxicUpdate")
    except KeyError:
        pass
    try:
